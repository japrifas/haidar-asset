...
@push('scripts')
    <script>
        ...
        window.addEventListener('hide_modal_add_user', function(event) {
            $('#modal_add_user').modal('hide');
        });
        window.addEventListener('showEditUserModal', function(event) {
            $('#modal_edit_user').modal('show');
        });
        window.addEventListener('hide_modal_edit_user', function(event) {
        ...
        window.addEventListener('deleteUser', function(event) {
            swal.fire({
                ...
                if (result.value) {
                    livewire.emit('deleteUserHandler', event.detail.id);
                }
            });
        });
    </script>
